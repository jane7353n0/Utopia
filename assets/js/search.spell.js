...
layout: none
---
const spellSchools = [{% for school in site.data.spells.school %}"{{school.name | downcase}}",{% endfor %}];
const types = [{% for type in site.data.spells.type %}"{{type.name | downcase}}",{% endfor %}];
